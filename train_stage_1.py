...
def log_validation(
    ...
    # cast unet dtype
    # vae = vae.to(dtype=torch.float32) # line 145
...
def main(cfg):
    ...
    # Initialize the optimizer AdamW 作为优化器
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % cfg.val.validation_steps == 0:
                    if accelerator.is_main_process:
                        ...
                        # 解决第200步发生矩阵不匹配问题 The shape of the mask [0] at index 0 does not match the shape of the indexed tensor [1, 9216, 320] at index 0
                        # reference_control_reader.clear()
                        # reference_control_writer.clear()
